...
import com.nixplorer.common.padEnd
import com.nixplorer.common.printFullStackTrace
import com.nixplorer.common.showMsg
import com.nixplorer.common.toJson
import com.nixplorer.screen.main.model.GithubRelease
import com.nixplorer.screen.main.startup.StartupTab
import com.nixplorer.screen.main.startup.StartupTabType
import com.nixplorer.screen.main.startup.StartupTabs
import com.nixplorer.screen.main.tab.Tab
import com.nixplorer.screen.main.tab.apps.AppsTab
...
class MainActivityManager {
    ...
    fun fetchGithubReleases(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val url = "https://api.github.com/repos/nikhilmenghani/NiXplorer/releases"
            ...
            try {
                ...
                connection.apply {
                    ...
                    setRequestProperty("User-Agent", "NiXplorer")
                }
