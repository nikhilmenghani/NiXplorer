...
import com.nixplorer.screen.main.tab.files.misc.FileListCategory
import com.nixplorer.screen.main.tab.files.provider.StorageProvider.getArchiveFiles
import com.nixplorer.screen.main.tab.files.provider.StorageProvider.getAudioFiles
import com.nixplorer.screen.main.tab.files.provider.StorageProvider.getBookmarks
import com.nixplorer.screen.main.tab.files.provider.StorageProvider.getDocumentFiles
import com.nixplorer.screen.main.tab.files.provider.StorageProvider.getImageFiles
import com.nixplorer.screen.main.tab.files.provider.StorageProvider.getRecentFiles
import com.nixplorer.screen.main.tab.files.provider.StorageProvider.getSearchResult
import com.nixplorer.screen.main.tab.files.provider.StorageProvider.getVideoFiles
