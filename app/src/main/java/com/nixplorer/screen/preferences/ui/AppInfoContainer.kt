package com.nixplorer.screen.preferences.ui
...
import com.nixplorer.screen.preferences.misc.exportPreferences
        ...
        PreferenceItem(
            ...
            onClick = {
                scope.launch {
                    ...
                    File(globalClass.appFiles.file, "preferences.nixPrefs").writeText(data)
                    showMsg(globalClass.getString(R.string.exported_nixplorer_preferences))
                }
            }
        )
