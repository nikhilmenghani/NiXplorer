...
import com.nixplorer.coil.apk.ApkFileDecoder
import com.nixplorer.coil.audio.AudioFileDecoder
import com.nixplorer.coil.pdf.PdfFileDecoder
import com.nixplorer.coil.zip.ZipFileFetcher
import com.nixplorer.coil.zip.ZipFileKeyer
import com.nixplorer.common.FileExplorerLogger
import com.nixplorer.screen.main.MainActivityManager
import com.nixplorer.screen.main.tab.files.coil.DocumentFileMapper
import com.nixplorer.screen.main.tab.files.holder.LocalFileHolder
import com.nixplorer.screen.main.tab.files.search.SearchManager
import com.nixplorer.screen.main.tab.files.task.TaskManager
import com.nixplorer.screen.main.tab.files.zip.ZipManager
import com.nixplorer.screen.preferences.PreferencesManager
import com.nixplorer.screen.textEditor.TextEditorManager
import com.nixplorer.screen.viewer.ViewersManager
...
class App : Application(), coil3.SingletonImageLoader.Factory {
    ...
    val appFiles: LocalFileHolder
        get() = LocalFileHolder(
            File(Environment.getExternalStorageDirectory(), ".nixplorer")
